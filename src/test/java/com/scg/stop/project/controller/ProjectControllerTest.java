...
public class ProjectControllerTest extends AbstractControllerTest {
    ...
    void getProjects() throws Exception {
        ...
        ProjectResponse projectResponse1 = new ProjectResponse(
                ...
                List.of("교수 이름 1"),
                ProjectType.STARTUP,
                ProjectCategory.BIG_DATA_ANALYSIS, List.of(AwardStatus.FIRST),
                2023,
                100,
                false,
                false,
        ...
        ProjectResponse projectResponse2 = new ProjectResponse(
                ...
                List.of("교수 이름 2"),
                ProjectType.LAB,
                ProjectCategory.AI_MACHINE_LEARNING, List.of(AwardStatus.SECOND),
                2023,
                100,
                false,
                true,
        ...
        result.andExpect(status().isOk())
                .andDo(restDocs.document(
                        ...
                        responseFields(
                                ...
                                fieldWithPath("content[].awardStatuses").type(JsonFieldType.ARRAY).description("수상 목록: FIRST, SECOND, THIRD, FOURTH, FIFTH"),
                                ...
                                fieldWithPath("content[].url").type(JsonFieldType.STRING).description("프로젝트 URL"),
        ...
        result.andExpect(status().isCreated())
                .andDo(restDocs.document(
                        requestFields(
                                ...
                                fieldWithPath("awardStatuses").type(JsonFieldType.ARRAY).description("수상 목록: FIRST, SECOND, THIRD, FOURTH, FIFTH"),
